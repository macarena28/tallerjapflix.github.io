...
fetch("https://japceibal.github.io/japflix_api/movies-data.json")
    ...
    .then(data => {
        peliculas = data; // Guardar datos de películas
    });

// Función para mostrar estrellas
function mostrarEstrellas(vote_average) {
    const estrellas = Math.round(vote_average / 2); // Convertir a escala de 5 estrellas
...
document.getElementById("btnBuscar").addEventListener("click", () => {
  ...
  if (busqueda) {
      const resultados = peliculas.filter(pelicula =>
          ...
          pelicula.genres.some(genero => typeof genero === 'string' && genero.toLowerCase().includes(busqueda)) ||
      ...
      resultados.forEach(pelicula => {
          ...
          li.className = "list-group-item bg-light mb-2";
          li.innerHTML = `
